...
# No intercept so this doesn't work
...
Okay something has gone horribly awry. Which coefficients are most off?

```{r}
my_cv_coef <- cv_results$final_model$coefficients
okay_coef <- halfhr_ridge_test$coefficients

diff <- my_cv_coef[1:length(okay_coef)] - okay_coef
```
