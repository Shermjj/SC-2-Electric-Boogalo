...
For hourly data, things are certainly a bit more messy, we theorize that the with more tuning of the hyperparameters we would get closer approximation of the daily cycles - whihc was not an issue with daily aggregated data.
