...
![Installation](~/docs/code/SC-2-Electric-Boogalo/notes/main_files/install.png)
...
?GenFT
```
![Documentation](~/docs/code/SC-2-Electric-Boogalo/notes/main_files/docs.png)
